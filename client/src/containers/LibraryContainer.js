...
import { libraryActions, playerActions, authActions } from '../actions';
...
export class LibraryContainer extends Component {
  ...
  render() {
    ...
    const { order, orderBy, anchorEl } = this.state;
      ...
      <div>
        ...
        {userAgentIsMobile ? (
          ...
          <LibraryDesktop
            ...
            handleMenuOptionClickEdit={this.handleMenuOptionClickEdit.bind(
              this
            )}
...
const mapStateToProps = state => {
  return {
    ...
    queueHasTracks: state.player.queue.length > 0
  };
};
